...
{	student s2;
	...
	cin>>n;char a[50];
	u u1;
	fstream outf("pack_unpack_variable_field.txt",ios::out|ios::ate|ios::app|ios::binary);
...
outf.close();*/
fstream outfile("smaplefile.txt",ios::out|ios::in|ios::binary);
cout<<"Enter the number of the field you want to delete";
int y;
cin>>y;
char ca[50];
for(int i=0;i<y;i++){
